...
<main id="main-content">
    ...
    <article class="legal-prose">
        ...
        <p>This Privacy Policy explains how <?php echo htmlspecialchars($siteName); ?> ("we", "us", "our") collects, uses, and protects your personal information when you visit <?php echo $domain; ?> or interact with our services.</p>
        ...
        <h3 id="state-rights"><?php echo $address['state']; ?> Residents</h3>
        ...
        <p><strong>How to exercise your rights:</strong> Email <a href="mailto:<?php echo $email; ?>"><?php echo $email; ?></a> or call <a href="tel:<?php echo formatPhone($phone); ?>"><?php echo $phone; ?></a>. We will respond within 45 days of receipt.</p>
